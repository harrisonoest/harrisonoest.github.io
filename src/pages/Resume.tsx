  ...
  if (verified) {
    return (
      <ContentColumn>
        ...
        >
          <p>
            It appears your browser does not support PDFs. Please download the
            PDF manually.
          </p>
        </object>
      ...
      <div className="captcha-container">
        ...
        {showError && (
          <div className="error-message">
            Incorrect selection. You have made {attempts} incorrect{" "}
        ...
        <p className="captcha-note">
          This is a simple verification to ensure you're a human.
        </p>
      </div>
    </ContentColumn>
  );
